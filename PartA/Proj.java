...
public class Proj {
	...
	public static void main(String[] args)
	{
		...
		for(Integer key : listIDName)
			{
				HashSet<Integer> a=hashMapIDCheck.get(key);
					if(a!=null)
						{
							ArrayList<Integer> arrayList3 =  new ArrayList<Integer>(hashMapIDCheck.get(key));
		...
		for(Integer key : listPair)
			{
				...
				if(a!=null)
					{
						ArrayList<Integer> listSupport =  new ArrayList<Integer>(hashMapIDCheck.get(key));
